    ...
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div
          ...
          className="absolute right-0 z-50 mt-2 w-64 origin-top-right animate-fade overflow-hidden rounded-xl border border-neutral-200 bg-white shadow-lg ring-1 ring-black/5 dark:border-neutral-800 dark:bg-neutral-950 dark:ring-white/10"
        >
