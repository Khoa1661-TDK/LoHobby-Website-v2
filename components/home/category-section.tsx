...
export default async function CategorySection({ category, products }: Props): Promise<ReactElement | null> {
    ...
    >
      ...
      {products.length > visible.length ? (
        <div className="mt-6 text-center">
          ...
          >
            {t('categoryViewMore', { count: products.length - visible.length })}
